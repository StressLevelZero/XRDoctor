...
[StructLayout(LayoutKind.Sequential)] public struct HmdVector3_t
{
	...
	public float v1;
	public float v2;
	public override string ToString() { return $"{nameof(v0)}: {v0}, {nameof(v1)}: {v1}, {nameof(v2)}: {v2}"; }
}
...
[StructLayout(LayoutKind.Sequential)] public struct TrackedDevicePose_t
{
	...
	public override string ToString() { return $"{nameof(mDeviceToAbsoluteTracking)}: {mDeviceToAbsoluteTracking}, {nameof(vVelocity)}: {vVelocity}, {nameof(vAngularVelocity)}: {vAngularVelocity}, {nameof(eTrackingResult)}: {eTrackingResult}, {nameof(bPoseIsValid)}: {bPoseIsValid}, {nameof(bDeviceIsConnected)}: {bDeviceIsConnected}"; }
}
